...
},
{
    ...
    desc  = "检测网站扫描工具，检查User-Agent的值为空的HTTP请求",
    match = {
        {
            vars = {
                {
...
},
{
    ...
    desc  = "检测搜索引擎蜘蛛，检查User-Agent的值含有关键字的HTTP请求",
    match = {
        {
            vars = {
                {
...
},
{
    ...
    desc  = "检测百度搜索引擎蜘蛛，检查User-Agent的值含有关键字的HTTP请求",
    match = {
        {
            vars = {
                {
...
},
{
    ...
    desc  = "检测谷歌搜索引擎蜘蛛，检查User-Agent的值含有关键字的HTTP请求",
    match = {
        {
            vars = {
                {
...
},
{
    ...
    desc  = "检测搜狗搜索引擎蜘蛛，检查User-Agent的值含有关键字的HTTP请求",
    match = {
        {
            vars = {
                {
...
},
{
    ...
    desc  = "检测雅虎搜索引擎蜘蛛，检查User-Agent的值含有关键字的HTTP请求",
    match = {
        {
            vars = {
                {
...
},
{
    ...
    desc  = "检测有道搜索引擎蜘蛛，检查User-Agent的值含有关键字的HTTP请求",
    match = {
        {
            vars = {
                {
